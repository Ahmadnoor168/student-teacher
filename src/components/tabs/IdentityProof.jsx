...
export default function IdentityProof() {
  ...
  const handleFileUpload = (e) => {
    ...
    if (files) {
      // Handle identity documents upload logic
    }
  };
    ...
    <div>
      ...
      <div className="border-2 border-dashed border-gray-700 rounded-lg mb-6">
        <div className="flex flex-col items-center justify-center p-8">
          ...
          <p className="text-gray-400 text-sm mb-2">Upload your identity proof here</p>
          <input
            type="file"
      ...
      {/* Documents List */}
      <div>
        <h3 className="text-white text-sm font-medium mb-4">Identity Documents</h3>
        {documents.length === 0 ? (
