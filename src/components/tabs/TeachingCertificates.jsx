...
export default function TeachingCertificates() {
  const [documents, setDocuments] = useState([]);

  const handleFileUpload = (e) => {
    const files = e.target.files;
    if (files) {
      // Handle teaching certificates upload logic
    }
  };
    ...
    <div>
      ...
      <div className="border-2 border-dashed border-gray-700 rounded-lg mb-6">
        <div className="flex flex-col items-center justify-center p-8">
          ...
          <p className="text-gray-400 text-sm mb-2">Upload your teaching certificates here</p>
          <input
            type="file"
            id="file-upload-teaching"
            className="hidden"
      ...
      {/* Documents List */}
      <div>
        <h3 className="text-white text-sm font-medium mb-4">Teaching Certificates</h3>
        {documents.length === 0 ? (
