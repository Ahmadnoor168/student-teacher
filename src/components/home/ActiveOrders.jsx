        ...
        {activeOrders.map((order) => (
          <div key={order.id} className="bg-[#1A1A1A] rounded-xl p-4">
            ...
            <div className="mb-4">
              ...
              {/* Map placeholder */}
              <div className="w-full h-20 bg-gray-800 rounded overflow-hidden relative">
                <div className="absolute right-2 top-2">
                  <svg className="w-6 h-6 text-[#1CD3C6]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button
              ...
              className="w-full py-2 text-sm font-medium text-white bg-[#1CD3C6] rounded hover:bg-[#19BFB3] transition-colors"
            >
              View Details
            </button>
          </div>
