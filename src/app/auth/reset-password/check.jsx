...
import loginImage from '@/assets/images/tick.png'
        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="mb-10">
            ...
            <p className="text-gray-400 text-base leading-relaxed">
              Enter a new password to regain access to your account. Make sure to choose a strong and secure password that you can remember.
            </p>
          </div>
      ...
      <div className="hidden lg:block w-1/2 relative overflow-hidden">
        <div className="absolute inset-0 bg-teal-400">
          ...
          <div className="flex flex-col items-center justify-center h-full text-white p-12 text-center">
            <div className="mb-6">
              <img src={loginImage.src} alt="Success" className="w-20 h-20" />
            </div>
